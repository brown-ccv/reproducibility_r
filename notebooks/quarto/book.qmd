...
::: callout-note
Now that you know how to write functions, **write a function that will plot the life expectancy of any country and include the name of the country as the title (using `ggtitle`** or `labs`).
:::
